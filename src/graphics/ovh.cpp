...
////
////        bb.min.x = std::min(bb.min.x, prim.aabb_min.x);
////        bb.min.y = std::min(bb.min.y, prim.aabb_min.y);
////        bb.min.z = std::min(bb.min.z, prim.aabb_min.z);
////        bb.max.x = std::max(bb.max.x, prim.aabb_max.x);
////        bb.max.y = std::max(bb.max.y, prim.aabb_max.y);
////        bb.max.z = std::max(bb.max.z, prim.aabb_max.z);
////    }
////    return bb;
////}
////
...
////            node.x8_aabb.min[0].m256_f32[i] = vvs[i].aabb_min.x;
////            node.x8_aabb.min[1].m256_f32[i] = vvs[i].aabb_min.y;
////            node.x8_aabb.min[2].m256_f32[i] = vvs[i].aabb_min.z;
////            node.x8_aabb.max[0].m256_f32[i] = vvs[i].aabb_max.x;
////            node.x8_aabb.max[1].m256_f32[i] = vvs[i].aabb_max.y;
////            node.x8_aabb.max[2].m256_f32[i] = vvs[i].aabb_max.z;
////        }
////        node.first_child = -1;
////        return;
////    }
